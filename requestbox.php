...
<body>
    ...
    <table>
        ...
        $sql = "SELECT * FROM req where to_user ='$excludename'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<form action='request_details.php' method='GET'>";
               
                echo "<input type='hidden' name='from_user' value='" . htmlspecialchars($row["from_user"]) . "'>";

                echo "<input type='hidden' name='to_user' value='" . htmlspecialchars($row["to_user"]) . "'>";
