...
<body>
    ...
    <table>
        ...
        $sql = "SELECT * FROM accept where work_provider ='$excludename'and work_status='completed'";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<form action='complete_details.php' method='GET'>";
                ...
                echo "<input type='hidden' name='work_status' value='" . htmlspecialchars($row["work_status"]) . "'>";
